...
autodoc_mock_imports = ['cv2','tqdm', 'qimage2ndarray', 'matplotlib','numpy','scipy','slicerator','ffmpeg','sh', 'pandas', 'importlib','trackpy','PyQt5','PyQt5.QtCore','PyQt5.QtGui',,'PyQt5.QtWidgets','QListWidget','filehandling','labvision','qtwidgets']
