...
def create_param_file(filename):
    ...
    postprocess = {
        ...
        'audio_frequency': {},
        'duty_to_acceleration': {'calibration_filepath': None},
    ...
    annotate = {
        ...
        'boxes': {'cmap_type': ['static', ('dynamic', 'static')],
                  ...
                  'colour_bar': None,  # (x,y,width,height) or None
                  'cmap_name': 'jet',
        ...
        'voronoi': {
            'cmap_type': ['static', ('dynamic', 'static')],
            # For dynamic                      'classifier': 1,#For static or dynamic
            'cmap_column': 'voronoi_area',
            'cmap_max': [100.0, 0, 1000.0, 0.1],  # For dynamic
            'cmap_min': [0.0, 0.0, 1000.0, 0.1],
            'colour_bar': None,  # (x,y,width,height) or None
            'cmap_name': 'jet',
